...
public interface IPalletRepository
{
    ...
    Task<int> InsertarAsync(int lineaProduccionId, bool esMixto, decimal? pesoReal);
    Task ActualizarEncabezadoAsync(int id, int lineaProduccionId, bool esMixto, decimal? pesoReal);
