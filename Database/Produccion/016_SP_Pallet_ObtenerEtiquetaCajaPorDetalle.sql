...
-- Variante de Produccion.sp_Pallet_ObtenerEtiquetaCaja (ver 014_Alter_EtiquetaCaja_Gs1VoiceCode.sql)
-- que en vez de traer el primer lote del pallet completo (TOP 1 por PalletId), trae exactamente
-- el renglón de detalle indicado — usada por PalletEditarForm para imprimir la etiqueta de Caja
-- de un renglón específico del grid de detalle.
SET QUOTED_IDENTIFIER ON;
GO

CREATE OR ALTER PROCEDURE Produccion.sp_Pallet_ObtenerEtiquetaCajaPorDetalle
    @PalletDetalleId INT
AS
BEGIN
    SET NOCOUNT ON;
