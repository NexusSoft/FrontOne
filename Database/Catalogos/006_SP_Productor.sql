...
BEGIN
    ...
    SELECT
        ...
        Poblacion, Municipio, EstadoId, Rfc, Telefono, Celular, Email,
...
BEGIN
    ...
    INSERT INTO Catalogos.Productor
        (Clave, NombreProductor, Domicilio, Colonia, CodigoPostal, Poblacion, Municipio,
...
CREATE OR ALTER PROCEDURE Catalogos.sp_Productor_Eliminar
    @Id INT
AS
BEGIN
    SET NOCOUNT ON;

    DELETE FROM Catalogos.Productor
    WHERE Id = @Id;
END
GO
