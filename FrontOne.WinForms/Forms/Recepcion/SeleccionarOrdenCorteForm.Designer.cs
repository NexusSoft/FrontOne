...
partial class SeleccionarOrdenCorteForm
{
    ...
    private GridColumn _colCajas;
    private SimpleButton _btnSeleccionar;
    private SimpleButton _btnCerrar;

    private void InitializeComponent()
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(SeleccionarOrdenCorteForm));
        ...
        _txtBuscar.Properties.NullValuePrompt = "Folio o huerta de la orden de corte";
        ...
        _gridView.Columns.AddRange(new GridColumn[] { _colFolio, _colFecha, _colHuerta, _colCajas });
        ...
        _colHuerta.Width = 300;
        //
        // _colCajas
        //
        _colCajas.Caption = "Cajas Entregadas";
        _colCajas.FieldName = "CajasEntregadas";
        _colCajas.Name = "_colCajas";
        _colCajas.Visible = true;
        _colCajas.VisibleIndex = 3;
        _colCajas.Width = 110;
        //
        // _btnSeleccionar
        //
