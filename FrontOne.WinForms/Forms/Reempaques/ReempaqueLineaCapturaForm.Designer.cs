...
partial class ReempaqueLineaCapturaForm
{
    ...
    private LabelControl _lblPalletDestino;
    private TextEdit _txtPalletDestino;
    ...
    {
        System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(ReempaqueLineaCapturaForm));
        _lblPalletDestino = new LabelControl();
        _txtPalletDestino = new TextEdit();
        ...
        ((System.ComponentModel.ISupportInitialize)_txtPalletDestino.Properties).BeginInit();
        ...
        _lblPalletDestino.Location = new Point(15, 18);
        _lblPalletDestino.Name = "_lblPalletDestino";
        _lblPalletDestino.Size = new Size(90, 13);
        _lblPalletDestino.Text = "Pallet Destino:";

        _txtPalletDestino.Location = new Point(130, 15);
        _txtPalletDestino.Name = "_txtPalletDestino";
        _txtPalletDestino.Properties.ReadOnly = true;
        _txtPalletDestino.Size = new Size(120, 20);
        _txtPalletDestino.TabIndex = 0;

        _lblLote.Location = new Point(15, 46);
        _lblLote.Name = "_lblLote";
        _lblLote.Size = new Size(90, 13);
        _lblLote.Text = "Lote de Saldo:";
        ...
        _txtKilosDisponibles.Location = new Point(485, 43);
        _txtKilosDisponibles.Name = "_txtKilosDisponibles";
        _txtKilosDisponibles.Properties.ReadOnly = true;
        _txtKilosDisponibles.Size = new Size(100, 20);
        _txtKilosDisponibles.TabIndex = 2;
        ...
        _spnPesoEstandar.Location = new Point(130, 99);
        ...
        _spnPesoEstandar.TabIndex = 4;

        _lblCajasPorPallet.Location = new Point(250, 102);
        ...
        _spnCajasPorPallet.Location = new Point(345, 99);
        ...
        _spnCajasPorPallet.TabIndex = 5;

        _lblPorcentajeMateriaSeca.Location = new Point(465, 102);
        ...
        _spnPorcentajeMateriaSeca.Location = new Point(485, 125);
        ...
        _spnCajas.TabIndex = 6;
        _spnCajas.EditValueChanged += SpnCajas_EditValueChanged;

        _lblKilogramos.Location = new Point(250, 128);
        ...
        _spnKilogramos.Location = new Point(345, 125);
        ...
        _btnCancelar.Location = new Point(505, 164);
        ...
        ClientSize = new Size(600, 199);
        Controls.Add(_lblPalletDestino);
        Controls.Add(_txtPalletDestino);
        ...
        MaximizeBox = false;
        MinimizeBox = false;
        Name = "ReempaqueLineaCapturaForm";
        StartPosition = FormStartPosition.CenterParent;
        Text = "Agregar línea de salida";
        ((System.ComponentModel.ISupportInitialize)_txtPalletDestino.Properties).EndInit();
